...
public sealed class LivePredictionEscDismissalGate : IPredictionEscDismissalGate
{
    ...
    public LivePredictionEscDismissalGate(
    ...
    public bool ShouldInterceptPlainEsc()
    {
